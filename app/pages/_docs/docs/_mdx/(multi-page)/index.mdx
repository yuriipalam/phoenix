...
<Callout type="info">
  ...
  vendors. This is not the sense in which the term _support_ is used in the
  context of the Apache HBase project. The Apache HBase team assumes no
  responsibility for your HBase clusters, your configuration, or your data.
</Callout>
