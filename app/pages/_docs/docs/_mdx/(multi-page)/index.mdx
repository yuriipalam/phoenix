...
Tables can be declared salted to avoid HBase region hotspotting. Declare a salt bucket count and Phoenix manages salting transparently. See details [here](/docs/salted-tables), and write-throughput comparison [here](/docs/performance#salting).
