...
Phoenix uses Skip Scan for intra-row scanning which allows for [significant performance improvement](/docs/performance#skip-scan) over Range Scan when rows are retrieved based on a given set of keys.
