...
Phoenix 5.2 also supports High Availability connections. Additional documentation is currently available in [PHOENIX-6491](https://issues.apache.org/jira/browse/PHOENIX-6491).
