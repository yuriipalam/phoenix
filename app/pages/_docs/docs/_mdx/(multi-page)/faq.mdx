...
**See [Using the Phoenix JDBC Driver](/docs/client-classpath-and-jdbc-url#using-the-phoenix-jdbc-driver) for a more up-to-date description**
...
or see the [Query Server documentation](/docs/query-server)

### Is there a way to bulk load in Phoenix?

#### Map Reduce

See the example [here](/docs/bulk-loading)
...
See [Secondary Indexing](/docs/secondary-indexes) for further information
...
You can force Phoenix to use secondary for uncovered columns by specifying an [index hint](/docs/secondary-indexes)
