...
## Overview [#user-defined-functions-overview]
...
## Configuration [#user-defined-functions-configuration]
...
<Steps>
  ...
  <Step>Run the [`CREATE FUNCTION`](/docs/grammar#create-function) query.</Step>
</Steps>
...
## Limitations [#user-defined-functions-limitations]
