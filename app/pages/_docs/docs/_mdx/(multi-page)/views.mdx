...
If your view uses only simple equality expressions in the WHERE clause, you are also allowed to issue DML against the view. These views are termed _updatable views_. For example, in this case you could issue the following UPSERT statement:
