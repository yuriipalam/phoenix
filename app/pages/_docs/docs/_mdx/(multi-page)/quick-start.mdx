...
***What is this new [Phoenix](/docs/index) thing I've been hearing about?***<br />
...
***Doesn't putting an extra layer between my application and HBase just slow things down?***<br />
...
***Ok, so it's fast. But why SQL? It's so 1970s***<br />
...
***But how can SQL support my favorite HBase technique of x,y,z***<br />
...
***Blah, blah, blah - I just want to get started!***<br />
...
***I don't want to download and setup anything else!***<br />
...
***Big deal - 10 rows! What else you got?***<br />
...
***Why is it called Phoenix anyway? Did some other project crash and burn and this is the next generation?***<br />
