...
- [Mapping an existing HBase table to a Phoenix table](/docs/index#mapping) and using the [UPSERT SELECT](/docs/grammar#upsert-select) command to populate a new table.
