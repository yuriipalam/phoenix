# PHO (Phoenix-HBase ORM) <img src="images/pho.png" width="70" height="70" hspace="90"/>

PHO is a Object Relational Mapping (ORM) library for building and executing queries on HBase using Apache Phoenix.
It provides ORM-like mappings and DSL-style query building. Initially developed and open sourced by
eHarmony, it is available [here](https://github.com/eHarmony/pho).
