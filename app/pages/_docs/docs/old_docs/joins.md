...
See our [Configuration and Tuning Guide](/docs/tuning) for more details.
...
Continuous efforts are being made to bring in more performance enhancement for join queries based on table statistics. Please refer to our [Roadmap](/docs/roadmap) for more information.
